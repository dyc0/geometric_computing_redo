...
def backtracking_line_search(p, grad, x, theta, beta, c, f, *arg):
    """
        ...
        - *arg: parameters
            The rest parameters for the function f except the its first variables Vx (do not assume the number of parameters)
...
def gradient_descent_with_line_search(V, F, x_csl, w, obj_tol, iter, theta, beta, c):
    """
